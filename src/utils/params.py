...
CF_CHEST_DATA = "/vol/bitbucket/iek19/data/chestxray/generated_cfs_data_age0.npy"
CF_CHEST_METRICS = "/vol/bitbucket/iek19/data/chestxray/generated_cfs_metrics_age0.csv"
